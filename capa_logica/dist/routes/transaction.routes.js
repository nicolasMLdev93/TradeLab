 ...
 */
router.get('/', transaction_validators_1.listTransactionsValidators, validate_middleware_1.validate, transaction_controller_1.list);
/**
 * @swagger
 * /api/transactions:
 *   post:
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.get('/:id', transaction_validators_1.transactionIdParamValidator, validate_middleware_1.validate, transaction_controller_1.getOne);
/**
 * @swagger
 ...
 */
router.patch('/:id/status', transaction_validators_1.transactionIdParamValidator, transaction_validators_1.updateStatusValidators, validate_middleware_1.validate, transaction_controller_1.updateStatus);
/**
 * @swagger
 * /api/transactions/{id}:
 *   delete:
 ...
 *             schema: { $ref: '#/components/schemas/Error' }
 */
router.delete('/:id', transaction_validators_1.transactionIdParamValidator, validate_middleware_1.validate, transaction_controller_1.remove);

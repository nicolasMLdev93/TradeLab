...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield queryInterface.bulkInsert('currencies', currencies.map((c) => (Object.assign(Object.assign({}, c), { created_at: now, updated_at: now }))));
    });
}
function down(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.bulkDelete('currencies', {
